...
fn connect(request: &Value) -> IrodoriConnectorBuffer {
    ...
    let connection = SearchConnection { client, config };
...
mod tests {
    ...
    fn a_certificate_file_with_no_pem_block_is_rejected() {
        ...
        // CA.
        let dir = std::env::temp_dir().join("irodori-elasticsearch-tls-test");
    ...
    fn an_api_key_still_wins_over_a_bearer_token() {
        // Precedence is unchanged: Elasticsearch treats an API key as the more
